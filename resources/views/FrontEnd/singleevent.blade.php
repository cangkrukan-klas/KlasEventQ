        ...
        <div class="row justify-content-center">
            ...
            <div class="col-12 col-md-8">
                <div class="blog_card">
                    ...
                    <img src="{{url('img/blog')}}/{{ $event->photo}}" alt="blog News ">
            ...
            <div class="col-12 col-md-4">
                <div class="sidebar">
                    <div class="widget widget_categories">
                        ...
                        <a href="http://localhost/eventq/public/events/2" class="btn btn-primary btn-rectagle">JOIN</a>
                    </div>
                    <div class="widget widget_categories">
                        ...
                        <ul>
                            <li><p>Pelaksanaan : {{ $event->start_date }} - {{ $event->end_date }}</p></li>
                        </ul>
                    </div>
                    ...
                    <div class="widget widget_tags">
                        ...
                        <ul>
                            <li><a href="">{{ $event->category_id }}</a></li>
                        </ul>
                    </div>
                </div>
            </div>
